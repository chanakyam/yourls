<?php
	 ...
	 */
	$aColumns = array( 'user_id','firstname','lastname', 'email', 'role','status');
	$aColumns_alias = array( 'user_id'=> 'user_id','firstname'=>'first_name', 'lastname'=>'last_name',"email"=>"email", "role"=>"role", "status"=>"status");
	...
	function addAliasColumn($str, $alias_column, &$row){
		...
		}else if($alias_column== "user_id" && in_array($alias_column, array_values($aColumns_alias)) ){
